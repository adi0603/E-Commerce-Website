	...
	<body>
        ...
        <form class="form-inline my-2 my-lg-0" method="POST">
          ...
          <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="search"><i class="fas fa-search"></i>&nbsp;Search</button>&nbsp;
    		...
    		<button class="btn btn-outline-success my-2 my-sm-0" onclick="location.href='Start.php'"><i class="fas fa-sign-in-alt"></i>&nbsp;&nbsp;Login</button>
    	</div>
		</nav>
    <div class="wrapper">
              ...
              if ($search=="") {
                ...
                if (mysqli_num_rows($result) > 0) {
                  ...
                  ?>
                    ...
                    <td>
                      <form method="POST">
                      <img src="image/shop/<?php echo $row['image']; ?>" alt="<?php $row['product_name']; ?>" class="center"><br>
