...
<html>
    ...
    <main class="page-main">
      <div class="container">
          <table>
            <tbody>
              <tr><th colspan="7">Product List</th></tr>
              <th>Product</th>
              <th>Title</th>
              <th>Discription</th>
              <th>Price</th>
              ...
              <th>View</th>
              <?php
              $result1 = mysqli_query($con,"Select image, price, type, cart.useremail, product_name, discription, order_id from product join cart where cart.product_id=product.product_id and product.status='3'");
